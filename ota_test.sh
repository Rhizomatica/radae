...
#       the length of the wave file after the chrip is used to extarct each sample.  Then: 
#       ./ota_test.sh -r rx.wav
...
#       Note the loss numbers display at the end, showing the comnparsion in loss between the tx and rx features
#
